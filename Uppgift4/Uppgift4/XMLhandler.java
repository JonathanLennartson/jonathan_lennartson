...
public class XMLhandler {
	private static final String SERIALIZED_FILE_NAME = "Personer.xml";

	static XMLEncoder encoder = null;
	static XMLDecoder decoder = null;
	static ArrayList<Person> list;

	public static void encode(Object name) {
		try {
	...
	public static void decode() {
		...
		XMLhandler.list = new ArrayList<>();
		list = (ArrayList<Person>) decoder.readObject();
